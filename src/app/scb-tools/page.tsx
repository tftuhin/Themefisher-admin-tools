    ...
    <div className="max-w-[1600px] mx-auto space-y-6">
      ...
      {showSalaryModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/50 backdrop-blur-xs animate-in fade-in duration-150">
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-150">
            {/* Modal Header */}
            <div className="p-4 sm:p-6 border-b border-slate-200 flex items-center justify-between bg-gradient-to-r from-emerald-50/60 to-teal-50/60 flex-shrink-0">
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-500 mt-1">
                  Generate Standard Chartered Bank bulk transfer Excel for employees and additional payouts.
                </p>
              </div>
              <button
