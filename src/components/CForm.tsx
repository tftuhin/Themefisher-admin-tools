  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="text-center text-[12.5px] mb-1.5 font-normal">(for AD’s use only)</div>
        <table className="w-full border-collapse border border-black text-center text-[12px] mb-4">
          <thead>
            <tr className="border-b border-black">
              <th className="border-r border-black py-1.5 px-3 font-normal w-[22%]">Month</th>
              <th className="border-r border-black py-1.5 px-3 font-normal w-[32%]">
                Country of ordering
                <br />
                customer
              </th>
              <th className="border-r border-black py-1.5 px-3 font-normal w-[20%]">Purpose</th>
        ...
        <div className="space-y-2 text-[12px] pb-1">
          ...
          <div className="pt-1">Signature and stamp of Authorized Dealer:</div>
          <div>Date:</div>
        </div>
      </div>
    </div>
